      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <section className="py-12 md:py-16 lg:py-20">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:mt-12 md:grid-cols-2">
            <Card className="relative overflow-hidden rounded-xl border-2 border-[#70E002]/40 bg-transparent p-8 md:p-10">
              <div className="mb-6 inline-flex h-10 w-10 items-center justify-center rounded-md border border-[#70E002]/50 bg-[rgba(112,224,2,0.1)]">
                <Trophy className="h-5 w-5 text-[#70E002]" />
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:mt-10 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-[#141414] p-6 shadow-sm md:p-7">
              <div className="flex items-start gap-4">
                <div className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[#70E002]/40 bg-[rgba(112,224,2,0.1)]">
                  <Crown className="h-5 w-5 text-[#70E002]" />
            ...
            <div className="rounded-xl border border-neutral-800 bg-[#141414] p-6 shadow-sm md:p-7">
              <div className="flex items-start gap-4">
                <div className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[#70E002]/40 bg-[rgba(112,224,2,0.1)]">
                  <Sparkles className="h-5 w-5 text-[#70E002]" />
            ...
            <div className="rounded-xl border border-neutral-800 bg-[#141414] p-6 shadow-sm md:p-7">
              <div className="flex items-start gap-4">
                <div className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[#70E002]/40 bg-[rgba(112,224,2,0.1)]">
                  <MessageSquare className="h-5 w-5 text-[#70E002]" />
            ...
            <div className="rounded-xl border border-neutral-800 bg-[#141414] p-6 shadow-sm md:p-7">
              <div className="flex items-start gap-4">
                <div className="mt-0.5 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[#70E002]/40 bg-[rgba(112,224,2,0.1)]">
                  <ShieldCheck className="h-5 w-5 text-[#70E002]" />
          ...
          <div className="relative overflow-hidden rounded-2xl border border-neutral-800 bg-[#101010] p-7 md:p-10">
            ...
            >
              <div className="relative">
                <div className="h-56 w-56 rotate-45 rounded-sm bg-[rgba(112,224,2,0.15)]" />
            ...
            <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-[1fr_auto]">
              ...
              <div className="md:pt-1">
                <Button
                  className="h-10 rounded-full bg-[#70E002] px-5 text-black hover:bg-[#4BA600] md:h-11 md:px-6"
