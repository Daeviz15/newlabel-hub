    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0c0c0c]/95 backdrop-blur supports-[backdrop-filter]:bg-[#0c0c0c]/75 transition-all duration-300">
      <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between gap-2 px-3 sm:h-16 sm:gap-4 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <nav className="hidden items-center gap-4 text-[13px] text-zinc-300 lg:flex xl:gap-5">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="start"
                className="bg-gradient-to-b from-[#3d1f5c] to-[#2a1540] text-white border border-[#6211A9]/30"
              >
                <DropdownMenuItem
                  onClick={() => navigate("/gospel-dashboard")}
                  className="hover:bg-[#6211A9]/20 focus:bg-[#6211A9] cursor-pointer"
                >
                  Gospeline
                </DropdownMenuItem>
                <DropdownMenuItem
                  onClick={() => navigate("/thc-dashboard")}
                  className="hover:bg-[#6211A9]/20 focus:bg-[#6211A9] cursor-pointer"
                >
                  Thc
                </DropdownMenuItem>
        ...
        <a
          href="/jcart"
          aria-label="Cart"
          className="items-center p-2 justify-center font-vietnam rounded-md bg-[#1a1a1a] text-white ring-1 ring-white/10 transition-all duration-200 hover:bg-[#222] hover:scale-105 sm:inline-flex sm:h-9 sm:w-9"
        >
