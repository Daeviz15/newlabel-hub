        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="inline-flex items-center bg-secondary rounded-full px-3 sm:px-4 py-2 mb-6 sm:mb-8">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs sm:text-sm text-green-100">
                Over 50,000 curious mind follow our content
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4 mb-12 sm:mb-16 px-4">
            <Button
              ...
              className="bg-brand-green hover:bg-brand-green-hover text-black font-semibold px-6 sm:px-8 py-3 text-base sm:text-lg w-full sm:w-auto"
            >
              Explore Our Content →
            </Button>
          </div>
