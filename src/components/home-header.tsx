  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0c0c0c]/95 backdrop-blur supports-[backdrop-filter]:bg-[#0c0c0c]/75 transition-all duration-300">
      <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between gap-2 px-3 sm:h-16 sm:gap-4 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <nav className="hidden items-center gap-4 text-[13px] text-zinc-300 lg:flex xl:gap-5">
            <a className="relative transition-colors duration-200 hover:text-white after:absolute after:bottom-[-2px] after:left-0 after:h-0.5 after:w-0 after:bg-lime-500 after:transition-all after:duration-300 hover:after:w-full" href="#">
              Explore
            </a>
            <a className="relative transition-colors duration-200 hover:text-white after:absolute after:bottom-[-2px] after:left-0 after:h-0.5 after:w-0 after:bg-lime-500 after:transition-all after:duration-300 hover:after:w-full" href="#">
              Catalogue
        ...
        <div className={`mx-auto hidden w-full max-w-[480px] items-center rounded-full px-4 py-2 text-[13px] text-zinc-300 transition-all duration-300 lg:flex xl:max-w-[560px] ${
          isSearchFocused 
            ? 'bg-[#333] ring-2 ring-lime-500/30 shadow-lg shadow-lime-500/10' 
            : 'bg-[#2a2a2a] hover:bg-[#2f2f2f]'
        }`}>
          <Search className={`mr-2 h-4 w-4 transition-colors duration-200 ${
      ...
      <div className="block w-full px-3 pb-3 sm:px-4 lg:hidden">
        <div className={`flex items-center rounded-full px-4 py-2.5 text-[13px] text-zinc-300 transition-all duration-300 ${
          isSearchFocused 
            ? 'bg-[#333] ring-2 ring-lime-500/30 shadow-lg shadow-lime-500/10' 
            : 'bg-[#2a2a2a]'
        }`}>
